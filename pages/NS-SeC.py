...
if page== 'L1, L2 and L3 Higher managerial, administrative and professional occupations':
  plot_wards(nssec_merge, column='C2021_NSSEC_10_NAME', string='L1, L2 and L3 Higher managerial, administrative and professional occupations', agg='sum',
  title='Number of people')

elif page== 'L4, L5 and L6 Lower managerial, administrative and professional occupations':
  plot_wards(nssec_merge, column='C2021_NSSEC_10_NAME', string='L4, L5 and L6 Lower managerial, administrative and professional occupations', agg='sum',
  title='Number of people')

elif page== 'L7 Intermediate occupations':
  plot_wards(nssec_merge, column='C2021_NSSEC_10_NAME', string='L7 Intermediate occupations', agg='sum',
  title='Number of people')  

elif page== 'L8 and L9 Small employers and own account workers':
  plot_wards(nssec_merge, column='C2021_NSSEC_10_NAME', string='L8 and L9 Small employers and own account workers', agg='sum',
  title='Number of people')  

elif page== 'L10 and L11 Lower supervisory and technical occupations':
  plot_wards(nssec_merge, column='C2021_NSSEC_10_NAME', string='L10 and L11 Lower supervisory and technical occupations', agg='sum',
  title='Number of people')  

elif page== 'L12 Semi-routine occupations':
  plot_wards(nssec_merge, column='C2021_NSSEC_10_NAME', string='L12 Semi-routine occupations', agg='sum',
  title='Number of people')  

elif page== 'L13 Routine occupations':
  plot_wards(nssec_merge, column='C2021_NSSEC_10_NAME', string='L13 Routine occupations', agg='sum',
  title='Number of people')  

elif page== 'L14.1 and L14.2 Never worked and long-term unemployed':
  plot_wards(nssec_merge, column='C2021_NSSEC_10_NAME', string='L14.1 and L14.2 Never worked and long-term unemployed', agg='sum',
  title='Number of people')  

elif page== 'L15 Full-time students':
  plot_wards(nssec_merge, column='C2021_NSSEC_10_NAME', string='L15 Full-time students', agg='sum',
  title='Number of people')  
