...
if page== 'Europe':
  plot_wards(country_birth_merge, column='C2021_COB_12_NAME', string='Europe', agg='sum',
  title='Number of people')

elif page== 'Europe: United Kingdom':
  plot_wards(country_birth_merge, column='C2021_COB_12_NAME', string='Europe: United Kingdom', agg='sum',
  title='Number of people')

elif page== 'Europe: EU countries':
  plot_wards(country_birth_merge, column='C2021_COB_12_NAME', string='Europe: EU countries', agg='sum',
  title='Number of people')

elif page== 'Europe: Non-EU countries':
  plot_wards(country_birth_merge, column='C2021_COB_12_NAME', string='Europe: Non-EU countries', agg='sum',
  title='Number of people')

elif page== 'Africa':
  plot_wards(country_birth_merge, column='C2021_COB_12_NAME', string='Africa', agg='sum',
  title='Number of people')

elif page== 'Middle East and Asia':
  plot_wards(country_birth_merge, column='C2021_COB_12_NAME', string='Middle East and Asia', agg='sum',
  title='Number of people')

elif page== 'The Americas and the Caribbean':
  ...
  plot_wards(country_birth_merge, column='C2021_COB_12_NAME', string='British Overseas ', agg='sum',
  title='Number of people')
