...
if page== 'No religion':
  plot_wards(religion_merge, column='C2021_RELIGION_10_NAME', string='No religion', agg='sum',
  title='Number of people')

elif page== 'Christian':
  plot_wards(religion_merge, column='C2021_RELIGION_10_NAME', string='Christian', agg='sum',
  title='Number of people')

elif page== 'Buddhist':
  plot_wards(religion_merge, column='C2021_RELIGION_10_NAME', string='Buddhist', agg='sum',
  title='Number of people')

elif page== 'Hindu':
  plot_wards(religion_merge, column='C2021_RELIGION_10_NAME', string='Hindu', agg='sum',
  title='Number of people')

elif page== 'Jewish':
  plot_wards(religion_merge, column='C2021_RELIGION_10_NAME', string='Jewish', agg='sum',
  title='Number of people')

elif page== 'Muslim':
  plot_wards(religion_merge, column='C2021_RELIGION_10_NAME', string='Muslim', agg='sum',
  title='Number of people')

elif page== 'Sikh':
  plot_wards(religion_merge, column='C2021_RELIGION_10_NAME', string='Sikh', agg='sum',
  title='Number of people')

elif page== 'Other religion':
  plot_wards(religion_merge, column='C2021_RELIGION_10_NAME', string='Other religion', agg='sum',
  title='Number of people')

elif page== 'Not answered':
  plot_wards(religion_merge, column='C2021_RELIGION_10_NAME', string='Not answered', agg='sum',
  title='Number of people')
