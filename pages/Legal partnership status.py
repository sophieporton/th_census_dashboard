...
if page== 'Never married and never registered a civil partnership':
  plot_wards(legal_partnership_merge, column='C2021_LPSTAT_12_NAME', string='Never married and never registered a civil partnership', agg='sum',
